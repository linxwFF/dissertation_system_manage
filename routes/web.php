...
Route::group(['middleware' => ['auth:admin', 'menu', 'authAdmin'],'prefix' => 'admin'], function () {
    ...
    Route::get('user/extra_property/{id}', ['as' => 'admin.user.index', 'uses' => 'Admin\Permission\UserController@get_extra_property']);//请求用户扩展数据
    Route::resource('user', 'Admin\Permission\UserController', ['names' => ['update' => 'admin.role.edit', 'store' => 'admin.role.create']]);
